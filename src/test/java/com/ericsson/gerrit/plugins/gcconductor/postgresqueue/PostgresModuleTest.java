...
import static com.ericsson.gerrit.plugins.gcconductor.postgresqueue.TestUtil.configInvalidMockFor;
...
public class PostgresModuleTest {
  ...
  public void shouldFailIfDatabaseNameIsInvalid() throws SQLException {
    module.provideGcDatabaseAccess(configInvalidMockFor(container));
  }
